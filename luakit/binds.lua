...
menu_binds = {
    -- Navigate items
    key({},          "e",       function (w) w.menu:move_down() end),
    key({},          "u",       function (w) w.menu:move_up()   end),
...
add_binds("normal", {
    ...
    -- Scrolling
    key({}, "e", "Scroll document down.",
        function (w) w:scroll{ yrel =  scroll_step } end),

    key({}, "u", "Scroll document up.",
        function (w) w:scroll{ yrel = -scroll_step } end),

    key({}, "n", "Scroll document left.",
        function (w) w:scroll{ xrel = -scroll_step } end),

    key({}, "i", "Scroll document right.",
        function (w) w:scroll{ xrel =  scroll_step } end),
    ...
    key({"Control"}, "e", "Scroll document down.",
        function (w) w:scroll{ ypagerel =  0.9 } end),
