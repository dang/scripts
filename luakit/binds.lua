...
add_binds("normal", {
    ...
    key({},          "s",           function (w) w:set_mode("insert")  end),
    key({},          ":",           function (w) w:set_mode("command") end),

    -- Scrolling
    key({},          "e",           function (w) w:scroll_vert(more)  end),
    key({},          "u",           function (w) w:scroll_vert(less)  end),
    key({},          "n",           function (w) w:scroll_horiz(less) end),
    key({},          "i",           function (w) w:scroll_horiz(more) end),
